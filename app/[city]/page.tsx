...
// 구 단위 메타데이터 (patternFn 제거 및 백틱 없는 문자열 병합)
export async function generateMetadata({
  ...
  // 1. 타이틀: 스팸 및 '마사지' 배제, 안전한 테라피 패턴
  const title = areaName + " " + modifier.prefix + " 바디케어 | " + BRAND_NAME;
  
  // 2. 메타 디스크립션: '출장'과 '마사지'를 완전히 분리
